...
public class VerifyConnectionRequest extends Request {
    ...
    private VerifyConnectionRequest(GoogleConfiguration configuration) {
        this.configuration = configuration;
    }

    public static VerifyConnectionRequest from(GoPluginApiRequest apiRequest) {
        return new VerifyConnectionRequest(GoogleConfiguration.fromJSON(apiRequest.requestBody()));
    }
